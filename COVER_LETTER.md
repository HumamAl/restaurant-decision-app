...
Are users picking solo or is this primarily a group decision tool — that shapes whether the bracket or the spin mechanic should be the hero feature?

The demo covers the core — want to discuss what the production version needs beyond this?
